...
interface IEchoServiceService_IEcho
  extends grpc.MethodDefinition<testapis_echo_service_pb.EchoRequest, testapis_echo_service_pb.EchoResponse> {
...
export interface IEchoServiceClient {
  echo(
    request: testapis_echo_service_pb.EchoRequest,
    callback: (error: grpc.ServiceError | null, response: testapis_echo_service_pb.EchoResponse) => void
